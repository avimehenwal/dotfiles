...
DNF=(catimg ShellCheck perl-Graph-Easy zsh fish cloc bat cargo flatpak cpan starship curl httpie exa ncdu wget hunspel parallel libwebp-tools fira-code-fonts fd-find toilet figlet prettyping)
CARGO=()
